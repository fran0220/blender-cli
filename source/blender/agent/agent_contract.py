...
REQUESTS = {
    "object": {
        ...
        "fields": {
            "action": {"type": "string", "required": True,
                       "enum": ["create", "transform", "delete", "select"], "doc": "Object operation."},
            "name": {"type": "string", "doc": "Object name; creation returns the actual name."},
            "type": {"type": "string", "enum": ["MESH", "ARMATURE", "EMPTY", "CAMERA", "LIGHT"],
                     "default": "MESH", "doc": "Object type to create."},
            "primitive": {"type": "string", "enum": ["cube", "plane", "uv_sphere", "cylinder"],
                          "default": "cube", "doc": "Mesh primitive to create."},
            "location": {"type": "array", "items": {"type": "number"}, "minItems": 3, "maxItems": 3,
                         "doc": "Object location in parent coordinates."},
            "rotation": {"type": "array", "items": {"type": "number"}, "minItems": 3, "maxItems": 3,
                         "doc": "Euler XYZ rotation in radians."},
            "scale": {"type": "array", "items": {"type": "number"}, "minItems": 3, "maxItems": 3,
                      "doc": "Object scale, not baked mesh coordinates."},
            "objects": {"type": "array", "items": {"type": "string"}, "doc": "Names to transform, select or delete."},
            "record": {"type": "boolean", "default": True, "doc": "Record this request as a program step."},
            "feedback": {"ref": "image_policy", "doc": "Image policy override for this request only."},
        },
    ...
    "data": {
        ...
        "mutates": {"set", "call"},
        "fields": {
            "action": {"type": "string", "required": True, "enum": ["get", "set", "call"], "doc": "RNA operation."},
    ...
    "operator": {
        ...
        "mutates": {"call"},
        "fields": {
            "action": {"type": "string", "required": True, "enum": ["call", "describe", "list"], "doc": "Operator operation."},
            "name": {"type": "string", "doc": "Upstream operator identifier."},
            "properties": {"type": "object", "doc": "Typed operator properties."},
            "objects": {"type": "array", "items": {"type": "string"}, "doc": "Explicit selected object names."},
            "active": {"type": "string", "doc": "Active object within the explicit selection."},
    ...
    "scene": {
        ...
        "mutates": True,
        "fields": {
            "action": {"type": "string", "required": True, "enum": ["reset", "frame", "save", "open"], "doc": "Scene operation."},
            "empty": {"type": "boolean", "default": True, "doc": "Reset to empty rather than the factory default scene."},
            "frame": {"type": "integer", "doc": "Frame to evaluate."},
    ...
    "rig": {
        ...
        "mutates": True,
        "fields": {
            "action": {"type": "string", "required": True, "enum": ["create", "bone", "bind"], "doc": "Rig operation."},
            "name": {"type": "string", "required": True, "doc": "Armature object name."},
            "bone": {"type": "string", "doc": "Name of the new bone."},
            "head": {"type": "array", "items": {"type": "number"}, "minItems": 3, "maxItems": 3, "doc": "Bone head in armature coordinates."},
            "tail": {"type": "array", "items": {"type": "number"}, "minItems": 3, "maxItems": 3, "doc": "Bone tail in armature coordinates."},
            "parent": {"type": "string", "doc": "Existing parent bone name."},
            "objects": {"type": "array", "items": {"type": "string"}, "doc": "Mesh objects to bind."},
            "weights": {"type": "string", "enum": ["automatic", "envelope", "empty"], "default": "automatic", "doc": "Native armature weighting method."},
            "record": {"type": "boolean", "default": True, "doc": "Record this request as a program step."},
            "feedback": {"ref": "image_policy", "doc": "Image policy override for this request only."},
        },
        "events": ["diff", "perception", "objective", "image", "done", "error"],
    ...
    "pose": {
        ...
        "mutates": True,
        "fields": {
            "action": {"type": "string", "required": True, "enum": ["set"], "doc": "Pose operation."},
            "name": {"type": "string", "required": True, "doc": "Armature object name."},
            "bone": {"type": "string", "required": True, "doc": "Pose bone name."},
            "location": {"type": "array", "items": {"type": "number"}, "minItems": 3, "maxItems": 3, "doc": "Pose channel location."},
            "rotation": {"type": "array", "items": {"type": "number"}, "minItems": 3, "maxItems": 3, "doc": "Euler XYZ rotation in radians."},
            "scale": {"type": "array", "items": {"type": "number"}, "minItems": 3, "maxItems": 3, "doc": "Pose channel scale."},
            "record": {"type": "boolean", "default": True, "doc": "Record this request as a program step."},
            "feedback": {"ref": "image_policy", "doc": "Image policy override for this request only."},
        },
        "events": ["diff", "perception", "objective", "image", "done", "error"],
    ...
    "animation": {
        ...
        "mutates": True,
        "fields": {
            "action": {"type": "string", "required": True, "enum": ["key", "delete", "bake"], "doc": "Animation operation."},
            "path": {"type": "string", "doc": "RNA property path from Main."},
            "frame": {"type": "number", "doc": "Keyframe time; defaults to the current frame."},
            "index": {"type": "integer", "minimum": -1, "default": -1, "doc": "Array component, or -1 for all components."},
            "start": {"type": "integer", "doc": "First bake frame, inclusive."},
            "end": {"type": "integer", "doc": "Last bake frame, inclusive."},
            "step": {"type": "integer", "minimum": 1, "default": 1, "doc": "Bake sampling interval in frames."},
            "objects": {"type": "array", "items": {"type": "string"}, "doc": "Objects whose evaluated transforms and poses are baked."},
            "record": {"type": "boolean", "default": True, "doc": "Record this request as a program step."},
            "feedback": {"ref": "image_policy", "doc": "Image policy override for this request only."},
        },
    ...
    "simulation": {
        ...
        "mutates": True,
        "fields": {
            "action": {"type": "string", "required": True, "enum": ["add", "bake", "free"], "doc": "Simulation operation."},
            "name": {"type": "string", "required": True, "doc": "Simulated object name."},
            "type": {"type": "string", "required": True,
                     "enum": ["RIGID_BODY", "CLOTH", "SOFT_BODY", "FLUID", "OCEAN"], "doc": "Blender simulation system."},
            "start": {"type": "integer", "doc": "First cache frame, inclusive."},
            "end": {"type": "integer", "doc": "Last cache frame, inclusive."},
    ...
    "render": {
        ...
        "mutates": True,
        "fields": {
            "action": {"type": "string", "required": True, "enum": ["frame", "animation"], "doc": "Render a frame or animation."},
            "frame": {"type": "integer", "doc": "Frame to evaluate before rendering."},
            "start": {"type": "integer", "doc": "First animation frame, inclusive."},
            "end": {"type": "integer", "doc": "Last animation frame, inclusive."},
            ...
            "width": {"type": "integer", "minimum": 1, "doc": "Output width in pixels at 100 percent scale."},
            "height": {"type": "integer", "minimum": 1, "doc": "Output height in pixels at 100 percent scale."},
            "samples": {"type": "integer", "minimum": 1, "doc": "Cycles or EEVEE render samples."},
            "record": {"type": "boolean", "default": True, "doc": "Record this request as a program step."},
            "feedback": {"ref": "image_policy", "doc": "Image policy override for this request only."},
        },
        "events": ["progress", "diff", "perception", "objective", "image", "done", "error"],
    ...
    "batch": {
        ...
        "fields": {
            ...
            "record": {"type": "boolean", "default": True, "doc": "Record the whole batch as one program step."},
            "feedback": {"ref": "image_policy", "doc": "Image policy override for this request only."},
        },
