...
Windows x64 measurement (2026-09-08, Windows 11 / RTX 5060, MSVC 19.44.35228,
Release full profile, source `e6d0f808cf4`, pinned Windows libraries
`60d6e96b917568278d400a4024c98da0fb777338`, standalone test binaries excluded):

| Measurement | Bytes | MiB |
|---|---:|---:|
| Installed logical files | 1,055,276,691 | 1,006.39 |
| Packaged logical files before regenerated bytecode | 863,481,733 | 823.48 |
| ZIP | 398,458,516 | 380.00 |

All 12 installed tests and all 12 CMake-derived scripts against the extracted
final ZIP pass. ZIP CRC/extraction and package smoke pass: 6,479 runtime files
and observation bytes identical. Actual NVIDIA Vulkan observation and GPU-only
CUDA/OptiX renders pass. HIP/HIPRT/oneAPI kernels compile, but AMD/Intel hardware
runtime validation is not available on this runner. Two device-less feedback
subcases are skipped in both suites because the GPU survives VK_DRIVER_FILES.
Archive SHA256: `5fa0b39631e40551c57e7acf4e6f9001786a5cb8baceeab806ddf44c60878801`.
Artifacts remain on the runner; this measurement is not a public release.
